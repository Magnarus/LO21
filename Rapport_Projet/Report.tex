...
\fancypagestyle{plain}{
    % Headers
    \fancyhead[R]{Rapport Projet LO21}
    \fancyhead[L]{Gregory \textsc{DELAUNAY} - Anaïs \textsc{NEVEUX}}
...
\title{Rapport Projet LO21}
\author{Gregory DELAUNAY et Anaïs NEVEUX}
\date\today
...
\begin{center}
\includegraphics[height=3cm]{ressources/UTC_logo.png}\\
\vspace{2.5cm}
...
\hline
    \multicolumn{2}{|c|}{Gregory \textsc{DELAUNAY} - Anaïs \textsc{NEVEUX}}\\
\hline
